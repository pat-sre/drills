...
def run_tests(solve):
    ...
    tests = [
        ...
        {
            "name": "full binary tree (preorder)",
            "inputs": {"root": t6},
            "check": lambda r: r == [1, 2, 4, 5, 3, 6, 7],
            "fail_msg": lambda r: f"expected [1, 2, 4, 5, 3, 6, 7], got {r}",
        },
        {
        ...
        },
        {
            ...
            "inputs": {"root": t9},
            "check": lambda r: r == [1, 2, 4, 5, 3],
            "fail_msg": lambda r: f"expected [1, 2, 4, 5, 3], got {r}",
        },
        {
            "name": "string values",
        ...
        },
        {
            "name": "larger tree",
            "inputs": {"root": t12},
            "check": lambda r: r == [1, 2, 4, 8, 5, 3, 6, 7],
            "fail_msg": lambda r: f"expected [1, 2, 4, 8, 5, 3, 6, 7], got {r}",
        },
    ]
